...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="status" class="box" required>
         <option value="<?= $fetch_videos['status']; ?>" disabled selected><?= ucfirst($fetch_videos['status']); ?></option>
      ...
      <select name="playlist" class="box">
         <option value="<?= $fetch_videos['playlist_id']; ?>" disabled selected>--Select Playlist</option>
         <?php

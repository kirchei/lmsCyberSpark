...
if (isset($_POST['submit'])) {
   ...
   if ($select_tutor->rowCount() > 0) {
      ...
      if ($pass != $cpass) {
         ...
         $message[] = 'New tutor registered! Please login';
      }
   }
}
   ...
   <section class="form-container">
      ...
      <form class="register" action="" method="post" enctype="multipart/form-data">
         ...
         <div class="flex">
            <div class="col">
               <p>Name <span>*</span></p>
               <input type="text" name="name" placeholder="John Smith" maxlength="50" required class="box">
               ...
               <p>Email <span>*</span></p>
               <input type="email" name="email" placeholder="tutor@hotmail.com" maxlength="50" required class="box">
            </div>
            <div class="col">
         ...
         <p class="link">Already have an account? <a href="login.php">Login Now</a> | <a href="../index.php">Back</a></p>
